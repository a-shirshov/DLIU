...
imageDescription = {'2': 'Подосиновик - съедобный гриб с крупной коричневой шляпкой, короткой толстой ножкой и белым трубчатым слоем под шляпкой. Часто встречается в лиственных лесах.',
                    ...
                    '0': 'Бледная поганка - гриб с белой или серовато-белой шляпкой, ножкой без кольца и пластинчатым слоем под шляпкой. Он часто встречается в лесах и на лугах.'}
imageTasty = {'2': 'Подосиновики считаются съедобными и широко используются в кулинарии.',
                    ...
                    '0': 'Бледная поганка является ядовитым грибом и не подходит для употребления в пищу.'}
imageLatin = {'2': 'Leccinum spp',
                    '1': 'Amanita spp',
                    '0': 'Chlorophyllum spp'}
...
def predictImageData(modelName, filePath):
    ...
    sess = onnxruntime.InferenceSession(r'/home/artyom/DLIU/hw-1-django/media/models/mushrooms_CNN_MobileNet.onnx') #<-Здесь требуется указать свой путь к модели
